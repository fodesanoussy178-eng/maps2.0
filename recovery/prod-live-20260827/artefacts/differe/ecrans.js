...
function ouvrirDetail(id) {
  ...
  ouvrirFeuille(
    ...
    '<p class="resume"><span>' + formatDist(distanceDepuisZone(l)) + "</span><span>" + tempsTrajetMinutes(
